...
<body>
    <div class="signup-form">
        ...
        <?php include('errors.php'); ?>
            ...
            <div class="form-group">
                <input type="date" class="form-control" name="date" placeholder="Születési dátum" required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <button type="submit" class="button" name="reg_user">Regisztrálás</button>
            </div>
        </form>
